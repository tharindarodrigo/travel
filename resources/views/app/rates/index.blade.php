                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        @endcan @can('view', $rate)
                                        <a
                                            href="{{ route('rates.show', $rate) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        @endcan @can('delete', $rate)
                                        <form
                                            action="{{ route('rates.destroy', $rate) }}"
                                            method="POST"
