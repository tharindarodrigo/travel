    ...
    if (data != null) {
        ...
        $.each(data, function (index, item) {
            ...
            if (index != 'total_cost') {
                ...
                table += '<tr>';
                table += '<td><span class="dark">' + 'Trip &nbsp;' + y + '</span> &nbsp;&nbsp;' + item.origin + '&nbsp;To&nbsp;' + item.destination + ' <button class="right btn delete_transport btn-xs btn-danger" value="' + index + '">X</button><br>' +
