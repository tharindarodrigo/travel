            ...
            <div class="col-md-8 pagecontainer2 offset-0">
                ...
                <ul class="nav nav-tabs" id="myTab">
                    ...
                    <li onclick="mySelectUpdate()" class=""><a data-toggle="tab" href="#preferences"><span
                                    class="preferences"></span><span class="hidetext">Preferences</span>&nbsp;</a></li>
                    ...
                    <li onclick="mySelectUpdate()" class=""><a data-toggle="tab" href="#thingstodo"><span
                                    class="thingstodo"></span><span class="hidetext">Things to do</span>&nbsp;</a></li>
                ...
                <div class="tab-content4">
                    ...
                    <div id="summary" class="tab-pane fade ">
                        <p class="hpadding20">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam auctor aliquam felis, sit
                            amet
                            tempus nibh ullamcorper nec. Maecenas suscipit dolor at blandit congue. Sed adipiscing, odio
                            feugiat pellentesque tincidunt, est leo vestibulum erat, ac pharetra massa justo ac lorem.
                        </p>
                        ...
                        <div id="collapse1" class="collapse in">
                            <div class="hpadding20">
                                ...
                                Cathedral, and Malaga Amphitheatre. Also nearby are Alcazaba and Picasso's Birthplace.
                            </div>
                            <div class="clearfix"></div>
                        </div>
                        <!-- End of collapse 1 -->
                                        ...
                                        <div class="w50percent">
                                            <div class="wh90percent textleft">
                                                ...
                                                <div class="addroom2 block grey"><a onclick="addroom3()"
                                                                                    class="grey cpointer">+ Add room</a>
                                                    |
                    ...
                    <div id="preferences" class="tab-pane fade">
                        <p class="hpadding20">
                            The hotel offers a snack bar/deli. A bar/lounge is on site where guests can unwind with a
                            drink.
                            ...
                            <div class="col-md-8 offset-0">
                                <div class="padding20">
                                    ...
                                    <p>The view from our balcony in room # 409, was terrific. It was centrally located
                                        ...
                                        very
                                        clean. The breakfast was below average, although not bad. If back in Zante Town
                                        we
                        ...
                        <div class="padding20">
                            ...
                            <div class="col-md-8 offset-0">
                                <div class="col-md-8 mediafix1">
                                    ...
                                    <p class="margtop10">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam
                                        velit
