...
@section('title')
    ...
    <meta name="keywords" content="{{ Excursion::where('id', $excursion_id)->first()->meta_keywords }}">
    <meta name="description" content="{{ Excursion::where('id', $excursion_id)->first()->meta_description }}">
    <title> {{ Excursion::where('id', $excursion_id)->first()->meta_title }} </title>
