...
<table border="0" width="100%" style="margin-top: -11px;">
    <tr>
        ...
        <td align="right"><h2 align="right" style="background: #00517e; padding: 10px; color: #FFFFFF ">Excursion
                Cancellation
        </td>
    </tr>
</table>
...
<table class="table" border="1px" cellpadding="10" cellspacing="0" width="100%" style="font-size: medium">
    ...
    <!--    <tr style="background: lightgrey">-->
    <!--        <th>Total</th>-->
    <!--        <td align="right"><strong>USD. -->
    <?php //echo number_format(ExcursionBooking::getTotalExcursionBookingAmount($booking), 2) ?><!--</strong></td>-->
    <!--    </tr>-->
