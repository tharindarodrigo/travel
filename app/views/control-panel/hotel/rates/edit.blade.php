    ...
    <div class="col-md-4">
        <div class="box box-primary">
            ...
            <div class="box-body table-responsive">
                ...
                <input id="old_from" value="{{$rate->from}}" type="hidden"/>
                <input id="old_to" value="{{$rate->to}}" type="hidden"/>
...
//        alert('asdasd');
        ...
        formObj.append('from',$('#old_from').val());
        formObj.append('old_from',$('#from').val());
        formObj.append('to',$('#to').val());
        formObj.append('old_to',$('#old_to').val());
        ...
        var url = 'http://'+window.location.host+'/control-panel/hotel/hotels/'+hotelid+'/rates/update-rates';
        $.ajax({
            url: url,
            method: 'post',
            processData: false,
            ...
            success: function(data){
                ...
                if(data.error) {
                    window.location = "http://locahost:8000";
                }
            },
