...
@section('title')
    ...
    <meta name="description"
          content="Online Book Transportation Packages Sri Lanka, Sri Lanka Tours, Sri Lanka Excursions, Sri Lanka Vehicles For Tourism,Tourist Vehicle,Tourist Van,Tourist Car,Tourist Bus">
                    ...
                    <div class="hotelstab2 none">
                        ...
                        <div class="transport_origin_show">
                            <div class="wh90percent textleft">
                                ...
                                {{ Form::select('from', $city, null, array('class' => 'form-control mySelectBoxClass transport_origin_select', 'id' => 'transport_origin')) }}
                            </div>
                            <div class="clearfix pbottom15"></div>
                        </div>
                        ...
                        <div class="transport_destination_show">
                            <div class="wh90percent textleft">
                                ...
                                {{ Form::select('to', $city, null, array('class' => 'form-control mySelectBoxClass transport_destination_select', 'id' => 'transport_destination')) }}
                            </div>
                            <div class="clearfix pbottom15"></div>
                        </div>
                        ...
                        <div class="radio">
                            <label>
                                <input type="radio" name="transport_type" id="predefine_transport"
                                       class="transport_type_select">
                                Predefined Packages
                            </label>
                        </div>
                        {{ Form::close() }}

                        {{ Form::open(array('url' => '/wedding-packages', 'method' => 'POST', 'id'=>'wedding_form')) }}
                        <div class="radio">
                            <label>
                                <input type="radio" name="transport_type" id="predefine_transport"
                                       class="wedding_type_select">
                                Wedding Packages
                            </label>
                        </div>
                        {{ Form::close() }}

                        {{ Form::open(array('url' => '/create-my-trip', 'method' => 'POST', 'id'=>'create_my_trip_form')) }}
                        <div class="radio">
                            <label>
                                <input type="radio" name="transport_type" id="create_my_trip"
                                       class="create_my_trip_type_select">
                                Create My Trip
                            </label>
                        </div>
                        {{ Form::close() }}
                        ...
                        @if($r < 3)
                            <div class="col-md-4 border">
                                ...
                                <div class="carscontainer">
                                    ...
                                    <div class="hpadding20">
                                        <a href="#" class="glyphicon glyphicon-info-sign right lblue cpointer"
                                           rel="popover"
                                           id="username{{ $transport_package->id }}"
                                           data-content="" data-original-title="">
                                        </a>

                                        <div id="popover_title_wrapper{{ $transport_package->id }}"
                                             style="display: none">
                                            <h4> {{ $transport_package->Vehicle->vehicle_type }} </h4>
                                        </div>

                                        <div id="popover_content_wrapper{{ $transport_package->id }}"
                                             style="display: none">
                                        ...
                                        <div class="size13 grey">
                                            ...
                                            <!-- Modal -->
                                            <div class="modal fade" id="myModal{{ $transport_package->id }}"
                                                 tabindex="-1"
                                                 role="dialog"
